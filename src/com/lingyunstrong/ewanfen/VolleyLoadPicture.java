...
public class VolleyLoadPicture {
   ...
   public VolleyLoadPicture(RequestQueue mRequestQueue,ImageView imageView,int defaulticon){
       one_listener = ImageLoader.getImageListener(imageView, defaulticon, defaulticon); 
